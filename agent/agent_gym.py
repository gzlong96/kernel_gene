...
class AGENT_GYM(gym.Env):
    ...
    def init(self, hole_pos, source_pos, agent_num):
        ...
        self.astar = GreedyAstar(source_pos, hole_pos, self.hole_city, agent_num, self.kernel, self.trans)
    ...
    def __init__(self, source_pos, hole_pos, agent_num, total_time, hole_city, city_dis, kernel, trans=None):
